...
const FooterComponent = () =>{
    return (
        <div className='p-10 lg:pl-20 lg:pr-20 bg-[#0e482b] w-full'>
            <div className='flex justify-between flex-wrap'>
                ...
                <div className='text-white mt-2'>
                    ...
                    <p className='mt-5 text-sm'>Our Heritage</p>
                    <p className='mt-5 text-sm'>Coffeehouse</p>
                    <p className='mt-5 text-sm'>Our Company</p>
                </div>

                <div className='text-white mt-2'>
                    <p className='mt-2 font-semibold text-xl'>Responsibility</p>
                    <p className='mt-5 text-sm'>Diversity</p>
                    <p className='mt-5 text-sm'>Community</p>
                    <p className='mt-5 text-sm'>Ethical Sourcing</p>
                    <p className='mt-5 text-sm'>Environmental Stewardship</p> 
                </div>

                <div className='text-white mt-2'>
                    <p className='mt-2 font-semibold text-xl'>Quick Links</p>
                    <p className='mt-5 text-sm'>Privacy Policy</p>
                    <p className='mt-5 text-sm'>FAQs</p>
                    <p className='mt-5 text-sm'>Starbucks India Mobile App Terms of Use</p>
                    <p className='mt-5 text-sm'>Customer Service</p>
                </div>
                ...
                <div className='mt-2'>
                    <p className='mt-2 cursor-pointer'>
                        <img src='	https://www.starbucks.in/assets/images/appstoreiOS.png' alt='ios store'></img>
                         
                    </p>
                    <p className='mt-2 cursor-pointer'>
                         
                        <img src='https://www.starbucks.in/assets/images/appstoreAndroid.png' alt='playstore'></img>
                    </p>
                </div>
            </div>

            <hr className='mt-16'></hr>
            <div className='text-white text-xs mt-3 font-thin flex justify-between'>
                <div>
                    <span>Web Accessiblity <span className='text-xl ml-2 mr-2'>&#124;</span></span>
                    <span>Privacy Statement <span className='text-xl ml-2 mr-2'>&#124;</span></span>
                    <span>Terms of Use <span className='text-xl ml-2 mr-2'>&#124;</span></span>
                    <span>Contact Us <span className='text-xl ml-2 mr-2'>&#124;</span></span>
                </div>
