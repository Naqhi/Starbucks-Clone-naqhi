        ...
        <div className=" pl-5 pr-5 xl:pl-20 xl:pr-20 mt-5 xl:flex xl:justify-between xl:items-center">
            <div className="xl:flex xl:items-center">
                ...
                <div className="flex flex-wrap justify-between">
                    <span className="xl:ml-12 ml-2 text-[#212529] font-semibold cursor-pointer underline underline-offset-8 decoration-[#00754a]">Home</span>
            ...
            <div className="flex flex-wrap justify-between items-center mt-5 xl:mt-0 xl:w-3/12">
                <div className="relative">
                    <svg 
                        ...
                        className="cursor-pointer w-5 h-5 texty-gray-500 dark:text-gray-400 absolute top-2 left-2"
                    >
                        <path 
                        fill-rule="evenodd" 
                        clip-rule="evenodd" 
                    ...
                    <input 
                        type="text" 
                        className="text-xs border-2 p-2 rounded-3xl pl-8 w-56 focus:border-black" placeholder="looking for something specific?"
                    /> 
                </div>
