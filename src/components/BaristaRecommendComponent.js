...
const BaristaRecommendComponent = () => {
    return (
    ...
    >
      <SwiperSlide>
        <div className="w-30 hauto bg-white rounded-lg shadow-sm p-4 cursor pointer">
            <div className="grid grid-cols-[1fr_3fr]">
                <div>
                    <img src="https://starbucksstatic.cognizantorderserv.com/Items/Small/webP/103515.webp" 
                    alt="Cappuccino" 
                ...
                <div className="p-2">
                    ...
                    <p className="font-semibold">Double Chocolate Chip Frappuccino</p>
                    <p className="text-xs text-[#6c757d]">{" "}TALL(354 ML).415 kcal{" "}</p>
                </div>
            </div>
      ...
      <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor pointer">
            <div className="grid grid-cols-[1fr_3fr]">
                ...
                <div className="p-2">
                    ...
                    <p className="text-xs text-[#6c757d]">{" "}SHORT(237 ML) .284 kcal{" "}</p>
                </div>
            </div>
            <div className="mt-5 flex justify-between items-center">
                <div>
                    <span className="font-semibold text-sm">₹ 294
      ...
      <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor pointer">
            <div className="grid grid-cols-[1fr_3fr]">
                ...
                <div className="p-2">
                    ...
                    <p className="text-xs text-[#6c757d]">{" "}ALL(354 ML) .PER SERVE (354ml) - 531 Kcal{" "}</p>
                </div>
            </div>
            <div className="mt-5 flex justify-between items-center">
                <div>
                    <span className="font-semibold text-sm">₹ 367
...
export default BaristaRecommendComponent;